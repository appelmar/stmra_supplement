...
model = stmra(part,stmra_cov_nonstationary_R2_separable,training_data, theta0 = theta0, lower = lower, upper= upper, trace = TRUE, control=list(ftol.abs = 0.2, max.iter = 500))
