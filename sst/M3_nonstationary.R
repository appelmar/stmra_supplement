...
model = stmra(part,stmra_cov_nonstationary_R2_separable,training_data, theta0 = theta0, lower = lower, upper= upper, trace = TRUE, control=list(ftol_abs = 0.2, maxeval = 500))
