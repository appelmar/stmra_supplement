...
upper = c( 50,   90,  30,  15,  15)
theta0 = c(8.63, 10, 4, 0.2, 0.2)
model = stmra(part,stmra_cov_separable_exp,training_data, theta0 = theta0, lower = lower, upper= upper, trace = TRUE, control=list(ftol.abs = 0.2, max.iter = 500))
